...
**Begruendung:** Die Metadaten bleiben damit entlang des bestehenden Vertrags sichtbar und stellen die statische Suchbasis fuer die Client-Filterlogik bereit. Alle publizierten Assets liegen unter demselben statischen Serving-Root und funktionieren lokal sowie beim Branch-Deploy aus `/docs`. Der exakte Spiegel verhindert veraltete Download-Dateien nach einem fehlgeschlagenen oder verkleinerten Korpuslauf.
